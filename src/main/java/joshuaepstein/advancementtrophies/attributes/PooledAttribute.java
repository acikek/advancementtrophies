...
import joshuaepstein.advancementtrophies.util.gson.IgnoreEmpty;
...
public abstract class PooledAttribute<T> extends MainAttribute.Instance<T> {

  protected PooledAttribute() {

  }

  protected PooledAttribute(MainAttribute.Modifier<T> modifier) {
    super(modifier);
  }

  public static abstract class Generator<T, O extends Generator.Operator<T>> implements MainAttribute.Instance.Generator<T> {
