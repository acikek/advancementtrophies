...
import joshuaepstein.advancementtrophies.util.ItemStackHelper;
...
public class ItemRendererTrophyUtil extends ItemRenderer {
    ...
    public ItemRendererTrophyUtil(TextureManager texManager, ModelManager modelManager, ItemColors colors) {
